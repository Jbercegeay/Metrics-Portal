...
Context: Brainstorming doc for agents and developers working on the Portal as operator headcount and station count grow.
...
| `PTFE` | PTFE | **Live** (Phase 1 + 1.5 complete) |
...
```
# Precision Liner (PL) — live
DEPT_PL_API_TOKEN=...
DEPT_PL_CONFIG_SHEET_ID=...
DEPT_PL_MASTER_LOG_SHEET_ID=...
DEPT_PL_HOUR_BY_HOUR_SHEET_ID=...   # PL uses H×H; submits at End Shift
DEPT_PL_DEFECT_SEEDS_SHEET_ID=...
DEPT_PL_HISTORICAL_YIELDS_SHEET_ID=...
DEPT_PL_ITEMS_SHEET_ID=...

# PTFE — live
DEPT_PTFE_API_TOKEN=...
DEPT_PTFE_CONFIG_SHEET_ID=...
DEPT_PTFE_MASTER_LOG_SHEET_ID=...
DEPT_PTFE_JOB_LOG_SHEET_ID=...      # PTFE uses Job x Job Log; submits at End Shift
DEPT_PTFE_STANDARDS_SHEET_ID=...
DEPT_PTFE_ITEMS_SHEET_ID=...
DEPT_PTFE_HISTORICAL_YIELDS_SHEET_ID=...
DEPT_PTFE_HOLIDAYS_SHEET_ID=...
# Note: PTFE does NOT use HOUR_BY_HOUR or DEFECT_SEEDS — different tracker format, no defect section

# Polyamide (PI) — planned
DEPT_PI_API_TOKEN=...
DEPT_PI_CONFIG_SHEET_ID=...
DEPT_PI_MASTER_LOG_SHEET_ID=...
DEPT_PI_JOB_LOG_SHEET_ID=...        # PI will use same Job x Job pattern as PTFE (to be created)
DEPT_PI_STANDARDS_SHEET_ID=...
DEPT_PI_ITEMS_SHEET_ID=...
DEPT_PI_HISTORICAL_YIELDS_SHEET_ID=...
DEPT_PI_HOLIDAYS_SHEET_ID=...
# Note: PI does NOT use HOUR_BY_HOUR or DEFECT_SEEDS
```
...
| Adding PI department | Follow Improvement 7 multi-department plan — PTFE is already the proven pattern |
